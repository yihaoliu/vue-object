...
export default {
  data(){
    return{
      ...
      localData: this.$store.getters.PHOTO_DETAIL,
  ...
  computed:{
    ...
    index(){
      return this.$store.getters.PHOTO_DETAIL.index
    },
    photoList(){
      return this.$store.getters.PHOTO_DETAIL.photoLists;
    }
  },
  mounted:function(){
  },
